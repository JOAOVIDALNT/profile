...
namespace profile.Infrastructure.Migrations
{
    ...
    [Migration("20251114010757_SetPluralSubscriberTableName")]
    partial class SetPluralSubscriberTableName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("profile.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("AuthorId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("SUBS_AUTHOR_ID");

                    b.Property<Guid>("SubscriberId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("SUBS_SUBSCRIBER_ID");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2")
                        .HasColumnName("SUBS_CREATED_AT");

                    b.Property<DateTime>("UpdatedAt")
                        .HasColumnType("datetime2")
                        .HasColumnName("SUBS_UPDATED_AT");
            ...
            modelBuilder.Entity("profile.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.HasOne("profile.Domain.Entities.Subscriber", "Subscriber")
